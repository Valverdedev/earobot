...
function Get-CommitteeFileName {
    ...
    switch ($Comite) {
        "pre-abertura" { return "gold-pre-abertura.json" }
        "meio-dia" { return "gold-meio-dia.json" }
        "pos-pregao" { return "gold-pos-pregao.json" }
    }
}
...
- Skill principal: $RootPath\.agents\skills\analisar-gold\SKILL.md
- Catalogo de estrategias: $RootPath\docs\catalogo-estrategias.md
- Config ativo esperado: D:\SistemEarobot\config\GOLD.config.json
- Relatorios GOLD: D:\SistemEarobot\relatorios\GOLD
