# Modelo obrigatorio do relatorio GOLD
...
```markdown
# Analise GOLD - <data/hora local ISO 8601>
...
| Fato confirmado | Impacto provavel no GOLD | Horizonte | Fonte direta | Publicado/evento em | Acessado em | Status |
|---|---|---|---|---|---|---|
...
- **Vies altista:** <fatos e invalidacao>
- **Vies baixista:** <fatos e invalidacao>
