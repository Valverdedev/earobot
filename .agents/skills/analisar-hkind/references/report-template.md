# Modelo obrigatorio do relatorio HKInd
...
```markdown
# Analise HKInd - <data/hora local ISO 8601>
...
| Fato confirmado | Impacto provavel no HKInd | Horizonte | Fonte direta | Publicado/evento em | Acessado em | Status |
|---|---|---|---|---|---|---|
...
- **Vies altista para HKInd:** <fatos e invalidacao>
- **Vies baixista para HKInd:** <fatos e invalidacao>
