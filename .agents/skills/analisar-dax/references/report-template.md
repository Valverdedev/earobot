# Modelo obrigatorio do relatorio DAX
...
```markdown
# Analise DAX - <data/hora local ISO 8601>
...
- **Motivos objetivos:** <idade, evento, ATR, regime, fonte, rolagem>
...
| Gap relevante | | gap_abs e gap_atr |
| Deslocamento desde analise anterior | | ATR H1 |

## 5. Fundamental e noticias

| Fato confirmado | Impacto provavel no DAX | Horizonte | Fonte direta | Publicado/evento em | Acessado em | Status |
|---|---|---|---|---|---|---|
...
- **Vies altista para DAX:** <fatos e invalidacao>
- **Vies baixista para DAX:** <fatos e invalidacao>
...
- **Motivo:** <evento, sessao, rolagem ou limite de 4h>
- **Antecipar se:** movimento > 1 ATR H1; rompimento de <nivel>; spread > <limite> sem filtro adequado; rolagem/vencimento; dados stale; noticia material; mudanca de regime.
```
