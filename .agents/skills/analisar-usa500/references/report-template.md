# Modelo obrigatorio do relatorio Usa500
...
```markdown
# Analise Usa500 - <data/hora local ISO 8601>
...
| Fato confirmado | Impacto provavel no Usa500 | Horizonte | Fonte direta | Publicado/evento em | Acessado em | Status |
|---|---|---|---|---|---|---|
...
- **Vies altista para Usa500:** <fatos e invalidacao>
- **Vies baixista para Usa500:** <fatos e invalidacao>
...
- **Motivo:** <evento, sessao, feriado ou limite de 4h>
- **Antecipar se:** movimento > 1 ATR H1; rompimento de <nivel>; spread > <limite> sem filtro adequado; feriado/sessao/ajuste; dados stale; noticia material; mudanca de regime.
```
